  ...
  return (
    <div id="mainheading">
      <div className="relative">
        <div className="flex flex-col md:flex-row justify-between items-center pt-20 px-6 md:px-12 bg-color h-[60vh] text-white relative z-10">
          <div className="flex flex-col gap-4 md:w-1/2">
            <div>
              ...
              {/* <p className="mt-4 text-sm md:text-md">
                Welcome to our real-time appointment website for patients.
                Connect with your doctor virtually and book appointments
                conveniently.
              </p> */}
            ...
            <div className="flex md:gap-16 gap-28 items-center justify-start mt-8">
              <Link to="provider" smooth={true} duration={1000} offset={-200}>
                <button className="bg-blue-500 text-white font-bold border-2 md:hover:scale-110 border-white px-2 md:px-8 py-1 md:py-2 rounded-md hover:bg-blue-800">
                  Join now
                </button>
              </Link>
              <Link
          ...
          <img
            src={cartoon}
            alt="Doctor"
            className="h-60 md:h-72  mt-8 md:mt-0"
          />
        </div>
      </div>
      ...
      <div className="h-1 mt-32 bg-color md:hidden"></div>
    </div>
  );
};
