    ...
    <>
      ...
      <div className="flex justify-between items-center px-4">
        ...
        {showUpload ? (
          ...
          <button
            className="md:text-xl text-sm border-2 border-blue-800 font-bold my-4 px-2 text-color"
      ...
      {showUpload ? (
        <div className="absolute top-0 left-0 w-full bg-gray-800 bg-opacity-75 flex items-center justify-center">
          <div className="bg-white p-8 rounded-lg flex">
            <button
              className="text-xl h-8 border-2 border-blue-800 font-bold px-2 text-color"
              onClick={handleCloseUpload}
            >
              &#10005;
            </button>
