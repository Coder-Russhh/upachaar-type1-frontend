...
import Lobby from "./pages/videoPage/Lobby";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/" element={loading ? <Loading /> : <LandingPage />} />

        {/* video----- */}
        <Route path="/doctor/videoLobby/:doctorId" element={<Lobby />} />
        ...
        <Route
          path="/patient/appointmentsrecord/:patientId"
          element={<AppointmentRecord />}
        />
        <Route
          path="/patient/medicalhistory/:patientId"
