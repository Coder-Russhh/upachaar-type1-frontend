  ...
  return (
    <div id="explore" className="text-center">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-6 px-12 text-black font-thin">
        {/* Card 1 */}
        <div className="md:h-[40vh] h-[25vh] flex flex-col p-4 rounded-3xl bg-color shadow-lg  border-2 border-bg-color hover:scale-105">
          ...
          <div className="bg-blue-500 rounded-b-3xl md:h-[50%] h-[10vh] flex flex-col justify-start items-center">
