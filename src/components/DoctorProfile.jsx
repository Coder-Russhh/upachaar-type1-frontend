  ...
  return (
    ...
    <div className="h-1 w-full bg-white"></div>
      <div className="container mx-auto p-4 flex flex-col md:flex-row items-center justify-center border-b-2">
        ...
        <div className="w-full md:w-2/3 m-4 bg-gray-300 rounded-lg shadow-lg p-6">
          {doctor ? (
            <>
              <h2 className="text-2xl text-center font-semibold mb-8 text-color underline">Doctor Profile</h2>
