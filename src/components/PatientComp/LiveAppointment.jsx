    ...
    <>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {appointments.map((appointment, index) => (
                <tr key={index}>
                  ...
                  <td
                    className="px-6 py-4 whitespace-nowrap border border-gray-400"
                  ...
                  <td className="px-6 py-4 whitespace-nowrap border border-gray-400">
                    {appointment.status === "pending" ? (
                      <div className="bg-blue-500 hover:bg-blue-700 text-center rounded-lg px-4 font-bold">
                        {appointment.status}...
                      </div>
                    ) : appointment.status === "completed" ? (
                      <div className="bg-purple-700 hover:bg-purple-900 text-center rounded-lg px-4 font-bold">
                        {appointment.status}
                      </div>
                    ) : appointment.status === "cancelled" ? (
                      <div className="bg-red-500 hover:bg-red-700 text-center rounded-lg px-4">
      ...
      {showUpdateForm && (
        <div className="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white md:h-[50vh] md:w-[50vw] w-[75vw] p-6 rounded-lg relative">
            <IoClose
