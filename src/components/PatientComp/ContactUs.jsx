  ...
  return (
    <div id="contact" className="container mx-auto my-12 px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="p-8 bg-white rounded-lg border-2 border-blue-800">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-blue-500 text-white font-bold py-2 px-4 rounded-md hover:bg-blue-700 w-full"
            >
              Submit
            </button>
          </form>
